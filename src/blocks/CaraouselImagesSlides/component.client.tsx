...
const defaultSteps: AllStepsSectionStep[] = [
  {
    ...
    cards: [
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/adit_voice_and_patient_card_a680e22694.gif`,
        alt: "Caller ID dashboard",
        caption: "On inbound ring, Adit immediately shows which patient is calling.",
      },
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/immediately_see_all_of_the_critical_action_items_to_discuss_with_that_patient_d8671093c5.png`,
        alt: "Call controls",
        caption: "Internal or 3‑way calls created in seconds to discuss while patient waits.",
      },
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/see_all_patients_and_add_any_notes_necessary_so_that_everyone_is_on_the_same_page_8b51332348.png`,
        alt: "Notes on screen",
  ...
  },
  {
    ...
    cards: [
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/allow_patients_to_check_in_complete_forms_on_adits_ipad_kiosk_8e6fcc20bd.png`,
        alt: "Tablet forms",
        caption: "Allow patients to check in and complete forms on Adit's iPad kiosk.",
      },
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/digital_form_gif_60866542c9.gif`,
        alt: "Mobile form",
  ...
  },
  {
    ...
    cards: [
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/asap_list1_gif_47d8d395ce.gif`,
        alt: "ASAP patient tile",
        caption: "Add patients who want earlier appointments into your ASAP list.",
      },
      {
        image: `${process.env.STRAPI_API_FOR_IMAGES}/uploads/asap_list2_gif_7e4a651f15.gif`,
        alt: "ASAP list",
