              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="flex items-center text-amber-400 text-sm sm:text-base" aria-hidden="true">
                  {[1, 2, 3, 4, 5].map((starNum) => (
                    <svg key={`avg-star-${starNum}`} className="w-4 sm:w-5 h-4 sm:h-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-1 mb-2">
                  ...
                  <div className="flex text-amber-400" aria-hidden="true">
                    {[1, 2, 3, 4, 5].map((starNum) => (
                      <svg key={`star-${starNum}`} className="w-4 h-4" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.95a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.45a1 1 0 00-.364 1.118l1.287 3.951c.3.921-.755 1.688-1.54 1.118l-3.37-2.45a1 1 0 00-1.176 0l-3.37 2.45c-.784.57-1.84-.197-1.54-1.118l1.287-3.95a1 1 0 00-.364-1.118L2.063 9.377c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69l1.286-3.95z"/></svg>
                    ))}
                  </div>
                </div>
