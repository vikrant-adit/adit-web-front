        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl">
             Book a 30-minute demo to discover how Adit automates reminders, manages online reviews, improves your overall patient engagement, and much more.
            </p>
...
<label className="block">
  <span className="text-sm text-slate-600 block mb-1">Best time to call</span>
  <div className="relative">
    <select
      value={form.bestTime}
