      ...
      <div className="bg-gray-50 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          {loading ? (
            ...
            <div className="text-center text-red-600">Error loading reviews: {error}</div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {reviews.map((review) => (
                <div key={review.id} className="relative bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm hover:shadow-md transition-shadow">
                  {/* Quote Icon */}
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <h3 className="text-xl font-bold text-gray-900">{review.client_name}</h3>
                      <span className="text-sm text-gray-500">{formatDate(review.date_added)}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-blue-600">{review.source}</span>
                      </div>
