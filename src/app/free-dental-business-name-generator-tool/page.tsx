...
export default function NameGenerator() {
  ...
  const generateBusinessNames = (): string[] => {
    const names: string[] = [];
    const keyword = keywords.trim().toLowerCase().replaceAll(/\s+/g, "");
    const loc = location.trim().toLowerCase().replaceAll(/\s+/g, "");
  ...
  const handleDomainClick = (domainName: string) => {
    const cleanDomain = domainName.replaceAll(/\s+/g, "");
          ...
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-white text-lg leading-relaxed max-w-4xl mx-auto">
                ...
                tool will give you a list of dental company names and their
              ...
              <div className="grid grid-cols-1 md:griad-cols-4 gap-4">
                ...
                <div className="md:col-span-1 relative">
                  ...
                  >
                    <span
                      className={
                        practiceType ? "text-gray-700" : "text-gray-500"
                      }
                    >
                    ...
                    <div className="absolute z-10 w-full mt-2 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                      {practiceTypes.map((type) => (
                        <button
                          ...
                          className="w-full text-left px-4 py-3 hover:bg-cyan-50 text-gray-700 transition-colors"
                        >
                          {type}
                        </button>
                      ))}
                ...
                {results.map((name) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mt-3">
                      Click to check availability on GoDaddy
                    </p>
                  </button>
                ))}
              </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 py-16 px-4">
            <div className="w-full max-w-6xl mx-auto text-center">
              <p className="text-xl text-slate-600">
                No results generated. Please try different keywords or location.
              </p>
            </div>
          </div>
        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="flex flex-col justify-center p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                    Useful tips and ideas for naming your new dental business
                    plus helpful steps you can take to get the creativity
                    flowing!
                  </p>
                  <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="flex flex-col justify-center p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                    ...
                    dental office and front desk needs to run smoothly? Check
                    out our FREE guide: Dental Office Startup Tech Checklist: 7
                    Core Systems To Explore Before Opening Your Door.
                    <p>What’s Inside:</p>
